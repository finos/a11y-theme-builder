...
export const ColorShadeCss: React.FC<Props> = ({className, name, id, lm, label, showId, showDetails,isBaseColor}) => {
    ...
    return (
        <div className={className ?? ""} style={isBaseColor ? {paddingTop:"2px",borderRadius:"8px",backgroundColor:"var(--primary-quarter"} : {}}>
            ...
            {isBaseColor&&<div className="inserted-item text-center " id="color-id" style={{fontWeight:"bold"}}>Base</div>}
