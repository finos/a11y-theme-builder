        ...
        <>
          ...
          >
            ...
            <div className="button-area">
              <Button
                variant="contained"
                onClick={() => navigator.clipboard.writeText(view)}
              >
                Copy to clipboard
              </Button>
              <Button variant="outlined" onClick={() => setView(null)}>
                Cancel
              </Button>
            </div>
            <div>
  ...
  return (
    <div className="system-card">
        ...
        <CardHeader
          ...
          subheader={
            <div className="date caption quiet">
              {renderDate(
                metadata && metadata.time ? metadata.time.lastUpdateInMs : null
              )}{' '}
              &nbsp;
            </div>
          }
      ...
      <Menu anchorEl={anchorEl} open={open} onClose={handleClose}>
        ...
        {isSample && (
          <MenuItem onClick={() => handleClose('remove')}>
            Remove from Samples Page
          </MenuItem>
        )}
        <Divider />
        <MenuItem onClick={() => handleClose('view')}>
          View Design System Data
        </MenuItem>
        <MenuItem onClick={() => handleClose('download')}>
          Download Design System Data
        </MenuItem>
        <Divider />
      ...
      <ModalSystemName
        ...
        message={`Enter the new Design System name to copy from "${name}".`}
      />
      <ModalSystemName
        isOpen={doRename}
        onClose={onClose}
        ...
        message={`Enter the new Design System name to rename "${name}".`}
      />
    </div>
  );
};
