...
const ModalFontEdit: React.FC<Props> = ({
    ...
    const typographyStyling = designSystem.getNode(
        textKey
    ) as TypographyStyling;
    ...
    const [fontFamilyWithPrefix, setFontFamilyWithPrefix] = useState<string>(
        fontFamily === primaryFont
            ? primaryFontWithPrefix
            : secondaryFontWithPrefix
    );
    ...
    const renderFontFamilySelectables = () => {
        return (
            <FormControl sx={{ m: 2, minWidth: 350 }}>
                ...
                >
                    <MenuItem
                        key={primaryFontWithPrefix}
                        value={primaryFontWithPrefix}
                    >
                        ...
                        <form>
                            ...
                            {fontUncommon || (
                                <Alert severity="info" sx={alertStyles}>
                                    This font is a common google font. <br /> It
                                    has the supported font weights:
                                    <br />
                                    <b>
                            ...
                            <FormControl sx={{ m: 2, minWidth: 500 }}>
                                ...
                                {isHeader || charSpacing > 0.12 * fontSize || (
                                    <Alert severity="error">
                                        WCAG AA guidelines require Line Height
                                        to be at least 0.12 times the font size.
                                    </Alert>
                                )}
                            </FormControl>
                        </form>
