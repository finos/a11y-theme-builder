      ...
      <div className="modal modal-fontHelp">
        <div className="modal-content">
          ...
          <div className="modal-body">
            <p>
              I have downloads, installed and added the 'Oswald' font to
              my&nbsp;
              <a
              ...
              &nbsp;Next, I will select Oswald in the Text dropdown in the
              Design panel.
            </p>
            <img src="/oswald.png" alt="Oswald" className="fontImage"></img>
            <p>
              I can then click to see the available font weights, by name. I
              select Light.
            </p>
            <img src="/light.png" alt="Light" className="fontImage"></img>
            <p>
              In order to coralate the font weight names with a number I click
              on the inspect tab and review the information provided under
              Typography.
            </p>
