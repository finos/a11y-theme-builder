...
export const CreateColorTheme: React.FC<Props> = ({
  ...
  if (_colorTheme) {
    return (
      <div className="content theme-page active" id="buildThemes">
        <HeadingSection title="Theme" heading="Create Default Theme">
          <p>
            Initialize the default color theme for this design designSystem by
            selecting colors that will be used throughout your application.
          </p>
        </HeadingSection>
                  ...
                  <div className="col-12">
                    <div className="formRow">
                      ...
                      <div className="form-columns top16">
                        <ColorSelect
                          value={_colorTheme.primary}
                          label="Primary"
                        ></ColorSelect>
                        <ColorSelect
                          value={_colorTheme.secondary}
                          label="Secondary"
                        ></ColorSelect>
                        <ColorSelect
                          value={_colorTheme.tertiary}
                          label="Tertiary"
                        ></ColorSelect>
                      </div>
                    </div>
                    <div className="formRow">
                      ...
                      <div className="form-columns top16">
                        <ColorPairSelect
                          value={_colorTheme.lightModeBackground}
                          label="Primary & Secondary Background Colors"
                        ></ColorPairSelect>
                      </div>
                    </div>
                    <div className="formRow">
                      ...
                      <div className="small">
                        Note: Your dark mode background options are limited to
                        colors in the 800 and 900 range of your color palette.
                      </div>
                      <div className="form-columns top16">
                        <ColorPairSelect
                          value={_colorTheme.darkModeBackground}
                          label="Primary & Secondary Background Colors"
                        ></ColorPairSelect>
                      </div>
                    </div>
                    <div className="formRow">
                      ...
                      <div className="small">
                        Note: The "To Color" will be limited to those colors
                        with the same "On Color" or text color to make sure the
                        gradiemt meets WCAG 2.1 AA contrast guidelines.
                      </div>
                      <div>
                        <ColorGradient
                          className="form-columns top16"
                          value={_colorTheme.gradient1}
                        />
                      </div>
                    </div>
                    <div className="formRow">
                    ...
                    <div className="formRow">
                      ...
                      <div className="small">
                        Note: Buttons limited to colors with a contrast against
                        your primary and secondary backgrounds of 3.1: 1 to meet
                        WCAG 2.1 AA Guidelines.
                      </div>
                      <div className="form-columns top16">
                        <ColorSelect
                          value={_colorTheme.button}
                          label="Color:"
                        ></ColorSelect>
                      </div>
                    </div>
                    <div className="formRow">
                      ...
                      <div className="small">
                        Note: Icons limited to colors with a contrast against
                        your primary and secondary backgrounds of 3.1: 1 to meet
                        WCAG 2.1 AA Guidelines.
                      </div>
                      <div className="form-columns top16">
                        <ColorSelect
                          value={_colorTheme.icon}
                          label="Color:"
                        ></ColorSelect>
                    ...
                    <div className="formRow">
                      ...
                      <div className="small">
                        Note: Large text gradient colors are limited to those
                        with a contrast against your background of 3.1: 1 to
                        meet WCAG 2.1 AA Guidelines.
                      </div>
                      <div className="form-columns top16">
                        <ColorGradientHeader
                          className="form-columns top16"
                          value={_colorTheme.gradientHeaderText}
                          sampleText="Sample Header"
                        />
                      </div>
                    </div>
                    <div className="formRow">
                      ...
                      <div className="small">
                        This color will be used for non-critical or decorative
                        accents and never appears with text or iconongraphy.
                      </div>
                      <div className="form-columns top16">
                        <ColorSelect
                          value={_colorTheme.accent}
                          label="Color:"
                        ></ColorSelect>
                      </div>
                    </div>
        ...
        <ModalConfirmation
          isOpen={_openConfirmation}
          onClose={handleConfirmation}
          title="Theme Initialized"
        >
          Your have successfully initialized your default color theme. If you
          select Cancel on this dialog, you will be able to make further
          changes. If you select OK or navigate away from this tab, you will no
          longer be able to make changes and will be presented with a readonly
    ...
    return (
      <div className="content theme-page active" id="buildThemes">
        <HeadingSection title="Theme" heading="Create Default Theme" />
        <div style={{ display: 'flex', gap: '40px' }}>No color palette</div>
      </div>
    );
  }
};
