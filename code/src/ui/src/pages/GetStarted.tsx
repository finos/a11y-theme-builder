    ...
    if (cmd == 'import') {
      ...
      if (data !== undefined) {
        ...
        try {
          ...
          if (isDesignSystemExist(dest))
            throw new Error('Design system already exists');
  ...
  return (
    <div>
      <HeadingSection title="Design Systems" heading="Getting Started">
        ...
        <p>
          A design system is created by building your atomic elements and then
          assigning them to core components.
        </p>
        <h6 style={{ margin: '0px' }}>Themes</h6>
        <p>
          Themes use the atomic styles and components defined in the Design
          Systems and skin the components in the defined Theme colors. Themes
          are children to Design Systems and every Design Systems must have at
          least one theme.
        </p>
        ...
        <ModalSystemName
          isOpen={systemNameIsOpen}
          onClose={() => setSystemNameIsOpen(false)}
        />
        <ModalSystemName
          isOpen={importIsOpen}
          ...
          message={`Enter the new Design System name.`}
          error={error}
        />
      </HeadingSection>
