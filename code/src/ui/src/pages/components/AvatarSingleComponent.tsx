    ...
    return (
        <div>
            ...
            <ExampleSection>
                ...
                <div>
                    Note: although these avatars look small they have a target
                    area equal to your min target height.
                </div>
                ...
                <Stack direction="row" spacing={1} alignItems="center">
                    <Avatar
                        className="clickable avatar xxs"
                        src="/profile.png"
                    />
                    <Avatar
                        className="clickable avatar xs"
                        src="/profile.png"
                    />
                    <Avatar
                        className="clickable avatar sm"
                        src="/profile.png"
                    />
                </Stack>
            </ExampleSection>
