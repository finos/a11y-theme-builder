  ...
  return (
    <div>
      <HeadingSection heading="Small Buttons" title="Desktop">
        This button still has a minimum click area of 44x44 but looks smaller
        and uses non-uppercased type.
      </HeadingSection>
      <ExampleSection>
        ...
        <div className="buttonDemo">
          ...
          <Button className="small-btn" variant="text" endIcon={barGraphIcon()}>
            Right Icon
          </Button>
