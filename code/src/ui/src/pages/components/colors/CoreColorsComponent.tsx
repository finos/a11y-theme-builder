      ...
      <ExampleSection>
        <div>
          ...
          <div className="theme-colors">
            ...
            <ComputedColorSwatch className="white-half" label="White Half" />
          </div>
          <div className="subtitle1 top40">Black</div>
          <div className="theme-colors">
            <ComputedColorSwatch className="black" label="Black" />
            <ComputedColorSwatch className="black-half" label="Black Half" />
          </div>
          <div className="subtitle1 top40">Near Black</div>
          <div className="theme-colors">
            <ComputedColorSwatch className="nearblack-bg" label="Near Black" />
          </div>
        </div>
