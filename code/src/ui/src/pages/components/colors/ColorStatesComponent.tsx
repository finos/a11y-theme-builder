      ...
      <div>
        ...
        <ExampleSection>
          <div className="theme-colors">
            ...
            <ComputedColorSwatch className="success" label="Success" />
            <ComputedColorSwatch className="warning" label="Warning" />
            <ComputedColorSwatch className="danger" label="Danger" />
          </div>
        </ExampleSection>
      </div>
    );
