...
export const SmallFontsStylesComponent: React.FC<Props> = () => {
    return (
        <div className="content">
            <HeadingSection
                title="Typography"
                heading="Small Text Styles"
            ></HeadingSection>
            <ExampleSection>
                <TypographyBox
                    cssPrefix={subtitle1CssPrefix}
                    sampleTitle="Subtitle 1"
                ></TypographyBox>
                <TypographyBox
                    cssPrefix={subtitle2CssPrefix}
                    sampleTitle="Subtitle 2"
                ></TypographyBox>
                <TypographyBox
                    cssPrefix={callToActionCssPrefix}
                    sampleTitle="CTA (CALL TO ACTION)"
                ></TypographyBox>
                <TypographyBox
                    cssPrefix={callToActionSmallCssPrefix}
                    sampleTitle="CTA-Small (Call to Action)"
                ></TypographyBox>
                <TypographyBox
                ...
                <TypographyBox
                    ...
                    sampleTitle="Caption Bold"
                ></TypographyBox>
                <TypographyBox
                    cssPrefix={overlineCssPrefix}
                    sampleTitle="OVERLINE"
                ></TypographyBox>
                <TypographyBox
                    cssPrefix={overlineLargeCssPrefix}
                    sampleTitle="OVERLINE LARGE"
                ></TypographyBox>
                <TypographyBox
                    cssPrefix={overlineXLCssPrefix}
                    sampleTitle="OVERLINE XL"
                ></TypographyBox>
                <TypographyBox
                ...
                <TypographyBox
                    ...
                    sampleTitle="Label 1 - All Capitalized"
                ></TypographyBox>
                <TypographyBox
                ...
                <TypographyBox
                    ...
                    sampleTitle="Label 2 - All Capitalized"
                ></TypographyBox>
                <TypographyBox
                    cssPrefix={labelSmallCssPrefix}
                    sampleTitle="LABEL SMALL"
                ></TypographyBox>
            </ExampleSection>
        </div>
    );
