...
import { BorderSettings } from '@finos/a11y-theme-builder-sdk';
  ...
  return (
    <div>
      <HeadingSection item={atom} title="Borders">
        <p>
          Modify these most popular border settings to affect the borders of
      ...
      <ExampleSection>
        ...
        >
          This shows the border radius and border width specified in the
          Settings section.
        </div>
        <SettingsSection>
          <div className="top40">
          ...
          <div className="top24">
            The base radius is used to calculate the border radius of all
