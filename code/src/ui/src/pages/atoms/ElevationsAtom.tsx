...
export const ElevationsAtom: React.FC<Props> = ({ elevationSettings }) => {
  ...
  const horizontalShadowLengthProperty =
    elevationSettings.horizontalShadowLength;
  ...
  const [baseSpreadRadius, setBaseSpreadRadius] = useState<number>(
    baseSpreadRadiusProperty.getValue() || 0
  );
  const [baseColorOpacity, setBaseColorOpacity] = useState<number>(
    baseColorOpacityProperty.getValue() || 0
  );
  ...
  const [colorOpacity, setColorOpacity] = useState<number>(
    colorOpacityProperty.getValue() || 0
  );
  ...
  return (
    <div>
      <HeadingSection item={elevationSettings} title="Elevations">
        Elevations create a senses of depth and replicated items places along
        the z-axis farther and father away from the surface.
      </HeadingSection>
      <ExampleSection>
        <SettingsSection>
            ...
            <div className="row">
              <div className="col-6">
                ...
                <div className="form-row">
                  <label className="label-1">Base Blur Radius</label>
                  <Slider
                ...
                <div className="form-row">
                  <label className="label-1">Base Spread Radius</label>
                  <Slider
                ...
                <div className="form-row">
                  <label className="label-1">Base Color Opacity</label>
                  <Slider
                ...
                <div className="form-row">
                  <label className="label-1">Color Opacity</label>
                  <Slider
                ...
                <div className="subtitle1 top16">
                  Percent change between elevations
                </div>
                <div className="form-row">
                  <label className="label-1">Percent change</label>
                  <Slider
              ...
              <div className="col-6">
                <div data-mode="light" style={{ display: 'flex', gap: '20px' }}>
                  <div style={{ flex: '1 1 0', width: '0' }}>
                    <LightModeSection>
                      Light mode elvations are created by layering an angled
                      shadow over a base shadow that becomes increasingly heavy
                  ...
                  <div data-mode="dark" style={{ flex: '1 1 0', width: '0' }}>
                    <DarkModeSection>
                      In darkmode elevations are represented by a backgrounds
                      with increasingly brightness. Drop shadows are hard to see
                      in darkmode. All shadows in darkmode are converted to
                      black.
                      <div className="subtitle1 top24">Sample Elevations</div>
                      <div className="top24" />
                      <ExampleElevation
