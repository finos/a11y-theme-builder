    ...
    return (
        <div>
            <HeadingSection item={elevationSettings} title="Elevations">
                Elevations create a senses of depth and replicated items places
                along the z-axis farther and father away from the surface.
            </HeadingSection>
            <ExampleSection>
                <SettingsSection>
                            ...
                            <div className="col-6">
                                ...
                                <div className="form-row">
                                    ...
                                    <Slider
                                        ...
                                        sx={{ maxWidth: 600 }}
                                        onChange={
                                            handleHorizontalShadowLengthChange
                                        }
                                        valueLabelDisplay="auto"
                                ...
                                <div className="form-row">
                                    ...
                                    <Slider
                                        ...
                                        sx={{ maxWidth: 600 }}
                                        onChange={
                                            handleVerticalShadowLengthChange
                                        }
                                        valueLabelDisplay="auto"
                            ...
                            <div className="col-6">
                                ...
                                >
                                    <div style={{ flex: '1 1 0', width: '0' }}>
                                        <LightModeSection>
                                            Light mode elvations are created by
                                            layering an angled shadow over a
                                            base shadow that becomes
                                            increasingly heavy as the elevation
                                            rises.
                                            <div className="subtitle1 top24">
                                                Sample Elevations
                                            </div>
                                            <div className="top24" />
                                            <ExampleElevation
                                    ...
                                    >
                                        <DarkModeSection>
                                            In darkmode elevations are
                                            represented by a backgrounds with
                                            increasingly brightness. Drop
                                            shadows are hard to see in darkmode.
                                            All shadows in darkmode are
                                            converted to black.
                                            <div className="subtitle1 top24">
                                                Sample Elevations
                                            </div>
