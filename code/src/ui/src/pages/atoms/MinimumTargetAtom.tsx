...
export const MinimumTargetAtom: React.FC<Props> = ({ atoms }) => {
    ...
    return (
        <div>
            ...
            >
                <div>
                    Define the minimum click area for your desktop experience.
                </div>
                <div className="top16">
                    WCAG AA requires a minimum target area of 24px, while WCAG
                    AAA requires a 44px target area.
                </div>
                <div className="top16">
                    Note: For tablet and mobile the target should be set to
                    44px.
                </div>
            </HeadingSection>
            <ExampleSection>
