...
export const MinimumTargetAtom: React.FC<Props> = ({ atoms }) => {
    ...
    const [minHeight,       setMinHeight]       = useState<number>((minHeightProperty.getValue()       || 44));
    const [mobileMinHeight, setMobileMinHeight] = useState<number>((mobileMinHeightProperty.getValue() || 44));
    ...
    const renderMinTargetSelectables = () => {
        ...
        return (
            <FormControl sx={{m: 2, minWidth: 120}}>
                ...
                <Select sx={{width: "100px"}} label={minHeightProperty.name} labelId={`minHeightLabel`} value={minHeight} onChange={handleMinHeightChange}>{r}</Select>
            </FormControl>
        )
    }
    const renderMobileMinTargetSelectables = () => {
        ...
        return (
            <FormControl sx={{m: 2, minWidth: 120}}>
                ...
                <Select sx={{width: "100px"}} label={mobileMinHeightProperty.name} labelId={`mobileMinHeightLabel`} value={mobileMinHeight} onChange={handleMobileMinHeightChange}>{r}</Select>
            </FormControl>
        )
    }
    ...
    return (
        <div>
            <HeadingSection item={atoms.minimumTarget} title="Theme" heading="Minimum Click Area">
