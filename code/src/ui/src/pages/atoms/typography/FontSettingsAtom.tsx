                ...
                <div className="form-row">
                    <Grid container spacing={textFieldGridSpacing}>
                        <Grid item xs={textFieldGridWidth}>
                            ...
                            <div style={{fontWeight:"normal"}}>For decorative and non critial text.</div>
                            <TextField 
                                id="fontWeight0TextField"
                                value={isNaN(fontWeight0) ? "" : ""+fontWeight0 }
                                onChange={handleFontWeight0Change}
                ...
                <div className="form-row">
                    <Grid container spacing={textFieldGridSpacing}>
                        <Grid item xs={textFieldGridWidth}>
                            ...
                            <TextField 
                                id="fontWeight1TextField"
                                value={isNaN(fontWeight1) ? "" : ""+fontWeight1 }
                                onChange={handleFontWeight1Change}
                                sx={{width:textFieldWidth, mb: textFieldMb }}
                            />
                        </Grid>
                        <Grid item xs={alertGridWidth}>
                ...
                <div className="form-row">
                    <Grid container spacing={textFieldGridSpacing}>
                        <Grid item xs={textFieldGridWidth}>
                            ...
                            <TextField 
                                id="fontWeight2TextField"
                                value={isNaN(fontWeight2) ? "" : ""+fontWeight2 }
                                onChange={handleFontWeight2Change}
                                sx={{width:textFieldWidth, mb: textFieldMb }}
                            />
                        </Grid>
                        <Grid item xs={alertGridWidth}>
                ...
                <div className="form-row">
                    <Grid container spacing={textFieldGridSpacing}>
                        <Grid item xs={textFieldGridWidth}>
                            ...
                            <TextField 
                                id="fontWeight3TextField"
                                value={isNaN(fontWeight3) ? "" : ""+fontWeight3 }
                                onChange={handleFontWeight3Change}
                                sx={{width:textFieldWidth, mb: textFieldMb }}
                            />
                        </Grid>
                        <Grid item xs={alertGridWidth}>
                ...
                <div className="form-row">
                    <Grid container spacing={textFieldGridSpacing}>
                        <Grid item xs={textFieldGridWidth}>
                            ...
                            <TextField 
                                id="fontWeight4TextField"
                                value={isNaN(fontWeight4) ? "" : ""+fontWeight4 }
                                onChange={handleFontWeight4Change}
                                sx={{width:textFieldWidth, mb: textFieldMb }}
                            />
                        </Grid>
                        <Grid item xs={alertGridWidth}>
