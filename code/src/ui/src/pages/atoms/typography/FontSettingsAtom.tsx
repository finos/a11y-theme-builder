...
export const FontSettingsAtom: React.FC<Props> = ({ atoms }) => {
  ...
  const recheckWeights = () => {
    ...
    if (secondaryFontUncommon) {
      ...
      if (
        !FontWeightsUtil.isWeightSupported(secondaryFont, secondaryFontWeight)
      ) {
      ...
      <ExampleSection>
        ...
        <SettingsSection>
            ...
            <Grid lg={4} md={12} sm={12}>
              <div>
                ...
                <ul>
                  ...
                  <li>
                    Make sure you only reference the available font
                    weights.&nbsp;
                    <a onClick={() => setFontHelpIsOpen(true)}>Need help?</a>
                  </li>
                </ul>
              </div>
              <h4>Font Families</h4>
              <div>
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      onChange={() => setSelectPrimaryFont(!selectPrimaryFont)}
                    />
                  }
                ...
                {primaryFontUncommon || (
                  <Alert severity="info" sx={alertStyles}>
                    ...
                    <br />
                    <b>
                      {FontWeightsUtil.getFontWeights(primaryFont)?.join(', ') +
                        '.'}
                    </b>
                  </Alert>
                )}
          ...
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={() => setSelectSecondaryFont(!selectSecondaryFont)}
              />
            }
          ...
          {secondaryFontUncommon || (
            <Alert severity="info" sx={alertStyles}>
              This font is a common google font. <br /> It has the supported
              font weights:
              <br />
              <b>
                {FontWeightsUtil.getFontWeights(secondaryFont)?.join(', ') +
                  '.'}
              </b>
            </Alert>
          )}
          ...
          <div className="form-row">
            <Grid container spacing={textFieldGridSpacing}>
              <Grid item xs={textFieldGridWidth}>
                ...
                <div style={{ fontWeight: 'normal' }}>
                  Used sparingly on text of great importance such as stats.
                </div>
                {renderFontWeightSelectables(
                  fontWeight4Property,
                  fontWeight4,
            ...
            <Grid container spacing={textFieldGridSpacing}>
              <Grid item xs={textFieldGridWidth}>
                ...
                <TextField
                  ...
                  value={
                    isNaN(standardLineHeight) ? '' : '' + standardLineHeight
                  }
