  ...
  return (
    <div className="container">
      <HeadingSection item={headerStylesAtom} title="Typography">
        ...
        In addition, the change in size between headers can be changed, along
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={7}>
                  {!fontWeightWarningTriggered || (
                    <Alert
                      severity="warning"
                      sx={{ width: 500, marginTop: 1, padding: 1 }}
                    >
                      The font weight provided is not supported by at least one
                      of the primary and secondary fonts.
                    </Alert>
                  )}
                </Grid>
              </Grid>
