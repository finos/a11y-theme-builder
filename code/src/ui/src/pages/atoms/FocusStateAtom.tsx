  ...
  return (
    <div>
      <HeadingSection item={focusStates} title="Focus States">
        <p>
          Settings that affect focus state for components such as textfields and
          cards
        </p>
        <p>
          Focus states need to have a contrast of 3.1 or higher against the
          selected background.
        </p>
      </HeadingSection>
      <ExampleSection>
        ...
        <SettingsSection>
          <FormControl>
            <FormControlLabel
              ...
              labelPlacement="top"
              control={
                <Checkbox checked={_focusBlur} onChange={handleBlurChange} />
              }
            />
          </FormControl>
        </SettingsSection>
