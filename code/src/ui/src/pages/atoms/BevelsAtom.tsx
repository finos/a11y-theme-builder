...
export const BevelsAtom: React.FC<Props> = ({ bevelSettings }) => {
  ...
  const [horizontalShadowLength, setHorizontalShadowLength] = useState<number>(
    horizontalShadowLengthProperty.getValue() || 0
  );
  ...
  return (
    <div>
      <HeadingSection item={bevelSettings} title="Bevels & Inverse Bevels">
        Bevels add 3D depth to a graphic or text object by making its edges
        appear sloped.
      </HeadingSection>
        ...
        <div className="row">
          <div className="col-6">
            <div className="form-row">
              <label className="label-1">Horizontal Shadow Length</label>
              <Slider
            ...
            <div className="form-row">
              <label className="label-1">Vertical Shadow Length</label>
              <Slider
            ...
            <div className="form-row">
              <label className="label-1">Light Glow Opacity</label>
              <Slider
