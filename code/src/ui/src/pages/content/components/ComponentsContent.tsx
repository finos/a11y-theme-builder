...
export const ComponentsContent: React.FC<Props> = ({ user, designSystem }) => {
    ...
    const [displayShadows, setDisplayShadows] =
        useState<boolean>(shadowSelected);
    useEffect(() => {
        ...
        <>
            ...
            >
                <div className="design-system-editor-right-content-scrollable">
                    {showComponent === 'Components' && <ComponentIntro />}
                    ...
                    {showComponent === 'imageList' && <ImagesList />}
