...
export const ComponentsContent: React.FC<Props> = ({ user, designSystem }) => {
  ...
  const [showComponent, setShowComponent] = React.useState(
    pref.get('components-content-selected') || 'colorsPrimary'
  );
  useEffect(() => {
    ...
    <>
          ...
          >
            ...
            <Collapse in={displayColors} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                <LeftNavItem
                  text={'Core Colors'}
                  value="colorsCoreColors"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('colorsCoreColors');
                  }}
                />
                <LeftNavItem
                  text={'Theme Colors'}
                  value="colorsThemeColors"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('colorsThemeColors');
                  }}
                />
                <LeftNavItem
                  text={'Extended Palette'}
                  value="colorsExtendedPalette"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('colorsExtendedPalette');
                  }}
                />
                <LeftNavItem
                  text={'Backgrounds'}
                  value="colorsBackgroundColors"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('colorsBackgroundColors');
                  }}
                />
                <LeftNavItem
                  text={'Gradients'}
                  value="colorsGradients"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('colorsGradients');
                  }}
                />
                <LeftNavItem
                  text={'States'}
                  ...
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('colorsStates');
                  }}
                />
                <LeftNavItem
                  text={'Hotlinks'}
                  value="colorsHotlinks"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('colorsHotlinks');
                  }}
                />
                <LeftNavItem
                  text={'Text'}
            ...
            <LeftNavItem
              text={'Shadows'}
              indent={1}
              onClick={() => setDisplayShadows(!displayShadows)}
            >
            ...
            <Collapse in={displayShadows} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                <LeftNavItem
                  text={'Elevations'}
                  value="shadowElevations"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('shadowElevations');
                  }}
                />
                <LeftNavItem
                  text={'Bevels'}
                  ...
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('shadowBevels');
                  }}
                />
                <LeftNavItem
                  text={'Inverted Bevels'}
                  value="shadowInvertedBevels"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('shadowInvertedBevels');
                  }}
                />
                <LeftNavItem
                  text={'Ridges'}
                ...
                <LeftNavItem
                  ...
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('shadowGrooves');
                  }}
                />
                <LeftNavItem
                  text={'Glows'}
            ...
            <LeftNavItem
              text={'Typography'}
              indent={1}
              onClick={() => setDisplayTypography(!displayTypography)}
            >
            ...
            <Collapse in={displayTypography} timeout="auto" unmountOnExit>
              <List component="div" disablePadding>
                <LeftNavItem
                  text={'Display'}
                  value="typographyPrimary"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('typographyPrimary');
                  }}
                  disabled={disabled}
                />
                <LeftNavItem
                  text={'Headers'}
                  value="typographyHeaders"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('typographyHeaders');
                  }}
                  disabled={disabled}
                />
                <LeftNavItem
                  ...
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('typographyBody');
                  }}
                  disabled={disabled}
                />
                <LeftNavItem
                  text={'Small Text Styles'}
                  value="typographySmallFontsStyles"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('typographySmallFontsStyles');
                  }}
                  disabled={disabled}
                />
                <LeftNavItem
                  text={'Stat Text Styles'}
                  value="statFontsStyles"
                  indent={2}
                  selected={showComponent}
                  onClick={() => {
                    setShowComponent('statFontsStyles');
                  }}
                  disabled={disabled}
                />
              </List>
            ...
            <LeftNavItem
              ...
              selected={showComponent}
              onClick={() => {
                setShowComponent('avatarsSingle');
              }}
              disabled={disabled}
            />
            ...
            <LeftNavItem
              ...
              selected={showComponent}
              onClick={() => {
                setShowComponent('breadcrumbs');
              }}
              disabled={disabled}
            />

            <LeftNavItem
              text={'Buttons - Standard'}
              value="buttonsStandard"
              indent={1}
              selected={showComponent}
              onClick={() => {
                setShowComponent('buttonsStandard');
              }}
              disabled={disabled}
            />
            <LeftNavItem
            ...
            <LeftNavItem
              ...
              selected={showComponent}
              onClick={() => {
                setShowComponent('buttonsGroups');
              }}
              disabled={disabled}
            />
            ...
            <LeftNavItem
              ...
              selected={showComponent}
              onClick={() => {
                setShowComponent('cardsStandard');
              }}
              disabled={disabled}
            />
            <LeftNavItem
              text={'Cards - with Icons'}
              value="cardsStandardIcons"
              indent={1}
              selected={showComponent}
              onClick={() => {
                setShowComponent('cardsStandardIcons');
              }}
              disabled={disabled}
            />
            <LeftNavItem
              text={'Cards - with Images 9:16 Ratio'}
              value="cardsImages"
              indent={1}
              selected={showComponent}
              onClick={() => {
                setShowComponent('cardsImages');
              }}
              disabled={disabled}
            />
            <LeftNavItem
              text={'Cards - with Images 9:21 Ratio'}
              value="cardsImages921"
              indent={1}
              selected={showComponent}
              onClick={() => {
                setShowComponent('cardsImages921');
              }}
              disabled={disabled}
            />
            ...
            <LeftNavItem
              text={'Cards - with Stats'}
              value="cardsStats"
              indent={1}
              selected={showComponent}
              onClick={() => {
                setShowComponent('cardsStats');
              }}
              disabled={disabled}
            />
            <LeftNavItem
              text={'Cards - with Stats & Icons'}
              value="cardsStatsIcons"
              indent={1}
              selected={showComponent}
              onClick={() => {
                setShowComponent('cardsStatsIcons');
              }}
              disabled={disabled}
            />
            <LeftNavItem
            ...
            <LeftNavItem
              ...
              selected={showComponent}
              onClick={() => {
                setShowComponent('imageDecorations');
              }}
              disabled={disabled}
            />
            ...
            <LeftNavItem
              ...
              selected={showComponent}
              onClick={() => {
                setShowComponent('multiselectDropdown');
              }}
              disabled={disabled}
            />
            ...
            <LeftNavItem
              ...
              selected={showComponent}
              onClick={() => {
                setShowComponent('tabsSecondary');
              }}
              disabled={disabled}
            />
            ...
            <LeftNavItem
              ...
              selected={showComponent}
              onClick={() => {
                setShowComponent('textDecoration');
              }}
              disabled={disabled}
            />

            <LeftNavItem
              text={'Toasts - Single Line'}
              value="toastsSingleLine"
              indent={1}
              selected={showComponent}
              onClick={() => {
                setShowComponent('toastsSingleLine');
              }}
              disabled={disabled}
            />
            <LeftNavItem
              text={'Toasts - Double Line'}
              value="toastsDoubleLine"
              indent={1}
              selected={showComponent}
              onClick={() => {
                setShowComponent('toastsDoubleLine');
              }}
              disabled={disabled}
            />
            <LeftNavItem
              text={'Toasts - Triple Line'}
              value="toastsTripleLine"
              indent={1}
              selected={showComponent}
              onClick={() => {
                setShowComponent('toastsTripleLine');
              }}
              disabled={disabled}
            />
      ...
      >
        <div className="design-system-editor-right-content-scrollable">
          {showComponent === 'colorsCoreColors' && <CoreColorsComponent />}
          {showComponent === 'colorsThemeColors' && <ThemeColorsComponent />}
          ...
          {showComponent === 'colorsGradients' && <GradientsComponent />}
          {showComponent === 'colorsStates' && (
            <ColorStatesComponent designSystem={designSystem} />
          )}
          {showComponent === 'colorsHotlinks' && <HotlinksComponent />}
          {showComponent === 'shadowElevations' && <ElevationComponent />}
          {showComponent === 'shadowBevels' && <BevelComponent />}
          {showComponent === 'shadowInvertedBevels' && (
            <InvertedBevelComponent />
          )}
          {showComponent === 'shadowRidges' && <RidgeComponent />}
          {showComponent === 'shadowGrooves' && <GrooveComponent />}
          {showComponent === 'shadowGlows' && <GlowComponent />}
          {showComponent === 'colorsText' && <TextComponent />}
          {showComponent === 'accordions' && <AccordionComponent />}
          {showComponent === 'appbar' && <TopAppBars />}
          {showComponent === 'avatarsSingle' && <AvatarSingleComponent />}
          {showComponent === 'breadcrumbs' && <BreadcrumbsComponent />}
          {showComponent === 'buttonsStandard' && <ButtonsStandardComponent />}
          {showComponent === 'buttonsSmall' && <ButtonsSmallComponent />}
          {showComponent === 'buttonsGroups' && <ButtonGroupsComponent />}
          {showComponent === 'typographyPrimary' && <DisplayComponent />}
          {showComponent === 'typographyHeaders' && <HeadersComponent />}
          {showComponent === 'typographyBody' && <BodyComponent />}
          {showComponent === 'typographySmallFontsStyles' && (
            <SmallFontsStylesComponent />
          )}
          {showComponent === 'statFontsStyles' && <StatStylesComponent />}
          {showComponent === 'cardsStandard' && <CardsStandardComponent />}
          {showComponent === 'cardsStandardIcons' && (
            <CardsStandardIconComponent />
          )}
          {showComponent === 'cardsImages' && <CardsImagesComponent />}
          {showComponent === 'cardsImages921' && <CardsImagesComponent921 />}
          {showComponent === 'cardsStats' && <CardsStatsComponent />}
          {showComponent === 'cardsStatsIcons' && <CardsStatsIconsComponent />}
          {showComponent === 'checkboxes' && <CheckboxesComponent />}
          {showComponent === 'chips' && <ChipsComponent />}
          {showComponent === 'divider' && <DividerComponent />}
          {showComponent === 'dropdown' && <DropdownComponent />}
          {showComponent === 'imageDecorations' && (
            <ImageDecorationsComponent />
          )}
          {showComponent === 'listsSingle' && <ListsSingleComponent />}
          {showComponent === 'listsDouble' && <ListsDoubleComponent />}
          {showComponent === 'listsTriple' && <ListsTripleComponent />}

          {showComponent === 'menus' && <MenusComponent />}
          {showComponent === 'multiselectDropdown' && (
            <MultiselectDropdownComponent />
          )}
          {showComponent === 'pagination' && <PaginationComponent />}
          {showComponent === 'popovers' && <PopoversComponent />}
          {showComponent === 'radioButtons' && <RadioButtonsComponent />}
          {showComponent === 'sliders' && <SlidersComponent />}
          {showComponent === 'switch' && <SwitchComponent />}
          {showComponent === 'tabsPrimary' && <PrimaryTabsComponent />}
          {showComponent === 'tabsSecondary' && <SecondaryTabsComponent />}
          {showComponent === 'textDecoration' && <TextDecorationComponent />}
          ...
          {showComponent === 'tooltips' && <TooltipsComponent />}
          {showComponent === 'hero' && <HeroExample />}
        </div>
      </div>
    </>
  );
