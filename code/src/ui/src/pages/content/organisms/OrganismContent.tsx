...
const templateList: {[key: string]:templateItem} = {
    textVariations: {value: "textVariations", label: "Text Only, Centered to Page", organism: "textVariations", disabled: false},
    textIconVariations: {value: "textIconVariations", label: "Text with Icon, Centered to Page", organism: "textIconVariations", disabled: false},
    decoractivetextVariations: {value: "decoractivetextVariations", label: "Decorative Text, Centered to Page", organism: "decoractivetextVariations", disabled: false},
    decoractivetextIconVariations: {value: "decoractivetextIconVariations", label: "Decorative Text with Icon, Centered to Page", organism: "decoractivetextIconVariations", disabled: false},
    imageText: {value: "imageText", label: "Image & Text", organism: "ImageText", disabled: false},
    backgroundimageText: {value: "backgroundimageText", label: "Background Image & Text", organism: "ImageText", disabled: false},
    fullBackground: {value: "fullBackground", label: "Full Width Backgrounds", organism: "fullBackground", disabled: false},
    fullVideo: {value: "fullVideo", label: "Full Width Video", organism: "fullVideo", disabled: false},
    listVariations: {value: "listVariations", label: "List - Single Line", organism: "listVariations", disabled: false},
    listsDoubleVariations: {value: "listsDoubleVariations", label: "List - Double Line", organism: "listsDoubleVariations", disabled: false},
    listsTripleVariations: {value: "listsTripleVariations", label: "List - Triple Line", organism: "listsTripleVariations", disabled: false},
    listVariationsClickable: {value: "listVariationsClickable", label: "Lists, Clickable - Single Line", organism: "listVariationsClickable", disabled: false},
    listsDoubleVariationsClickable: {value: "listsDoubleVariationsClickable", label: "Lists, Clickable - Double Line", organism: "listsDoubleVariationsClickable", disabled: false},
    listsTripleVariationsClickable: {value: "listsTripleVariationsClickable", label: "Lists, Clickable - Triple Line", organism: "listsTripleVariationsClickable", disabled: false},
    listsDoubleVariationsImageLeft: {value: "listsDoubleVariationsImageLeft", label: "List - Double Line", organism: "listsDoubleVariationsImageLeft", disabled: false},
    listsDoubleVariationsClickableImageLeft: {value: "listsDoubleVariationsClickableImageLeft", label: "Lists, Clickable - Double Line", organism: "listsDoubleVariationsClickableImageLeft", disabled: false},
    cardVariationsStandard: {value: "cardVariationsStandard", label: "Cards, Standard", organism: "cardVariationsStandard", disabled: false},
    cardVariationsIcons: {value: "cardVariationsIcons", label: "Cards, with Icons", organism: "cardVariationsIcons", disabled: false},
    imageCardVariations: {value: "imageCardVariations", label: "Cards, with Images 9:21", organism: "imageCardVariations", disabled: false},
    imageCard916Variations: {value: "imageCard916Variations", label: "Cards, with Images 9:16", organism: "imageCard916Variations", disabled: false},
    pricingCardVariations: {value: "pricingCardVariations:", label: "Cards, with Pricing", organism: "pricingCardVariations:", disabled: false},
    statCardVariations: {value: "statCardVariations:", label: "Cards, with Stats", organism: "statCardVariations:", disabled: false},
    staticonCardVariations: {value: "staticonCardVariations:", label: "Cards, with Stats & Icons", organism: "staticonCardVariations", disabled: false},
    imagesOnlyVariations: {value: "imagesOnlyVariations", label: "Images Only", organism: "imagesOnlyVariations", disabled: false},
    videoVariations: {value: "videoVariations", label: "Videos", organism: "videoVariations", disabled: false},
    youTubeVariations: {value: "youTubeVariations", label: "YouTube Videos", organism: "youTubeVariations", disabled: false},
    footerVariations: {value: "footerVariations", label: "Footers", organism: "footerVariations", disabled: false},
    teamVariations: {value: "teamVariations", label: "Teams", organism: "teamVariations", disabled: false},
    featureVariations: {value: "featureVariations", label: "Feature Highlights", organism: "featureVariations", disabled: false},
    testimonialVariations: {value: "testimonialVariations", label: "Testimonials", organism: "testimonialVariations", disabled: false},
    testimonCardVariations: {value: "testimonCardVariations", label: "Testimonial Cards", organism: "testimonCardVariations", disabled: false},
    heroVariations: {value: "heroVariations", label: "Heros", organism: "heroVariations", disabled: false},
...
export const OrganismContent: React.FC<Props> = ({ user, designSystem }) => {
    ...
    const [organisms, setorganisms] = useState<{[key: string]:templateItem}>(templateList);
    useEffect(() => {
    }, [organisms])

    const [showTemplate, setShowTemplate] = React.useState(pref.get("template-content-selected") || "organisms");
    useEffect(() => {
    ...
    return (
        <>
            ...
            <div className="design-system-editor-left-nav-scrollable">
                ...
                >
                    ...
                    <Collapse in={displayText} timeout="auto" unmountOnExit>
                      ...
                      <List component="div" disablePadding>
                          <LeftNavorganisms item={organisms.textIconVariations} indent={2} />
                      </List>
                      <List component="div" disablePadding>
                          <LeftNavorganisms item={organisms.decoractivetextVariations} indent={2} />
                      </List>
                      <List component="div" disablePadding>
                          <LeftNavorganisms item={organisms.decoractivetextIconVariations} indent={2} />
                      </List>
                    </Collapse>
                    ...
                    <Collapse in={displayGeneral} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.imagesOnlyVariations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.imageText} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.backgroundimageText} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                    ...
                    <Collapse in={displayVideo} timeout="auto" unmountOnExit>
                        ...
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.youTubeVariations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                    ...
                    <Collapse in={displayLists} timeout="auto" unmountOnExit>
                        ...
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.listsDoubleVariations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.listsTripleVariations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.listVariationsClickable} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.listsDoubleVariationsClickable} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.listsTripleVariationsClickable} indent={2} />
                        </List>
                    </Collapse>
                    ...
                    <Collapse in={displayListsImageLeft} timeout="auto" unmountOnExit>
                        ...
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.listsDoubleVariationsImageLeft} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.listsDoubleVariationsClickableImageLeft} indent={2} />
                        </List>
                    </Collapse>
                    ...
                    <Collapse in={displayCardsClickable} timeout="auto" unmountOnExit>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.cardVariationsStandard} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.cardVariationsIcons} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.imageCard916Variations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.imageCardVariations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.statCardVariations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.staticonCardVariations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.pricingCardVariations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                    ...
                    <Collapse in={displayOther} timeout="auto" unmountOnExit>
                        ...
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.footerVariations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.teamVariations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.featureVariations} indent={2} />
                        </List>
                        <List component="div" disablePadding>
                            <LeftNavorganisms item={organisms.testimonialVariations} indent={2} />
                        </List>
            ...
            <div className="design-system-editor-right-content-scrollable">
                ...
                {showTemplate === organisms.listsDoubleVariationsClickableImageLeft.value && (
                    <ErrorHandler>
