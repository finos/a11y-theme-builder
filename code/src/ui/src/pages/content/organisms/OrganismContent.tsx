        ...
        <>
                    ...
                    >
                        ...
                        <Collapse in={displayText} timeout="auto" unmountOnExit>
                            ...
                            <List component="div" disablePadding>
                                <LeftNavorganisms
                                    item={
                                        organisms.decoractivetextIconVariations
                                    }
                                    indent={2}
                                />
                            </List>
                        ...
                        >
                            <List component="div" disablePadding>
                                <LeftNavorganisms
                                    item={organisms.videoVariations}
                                    indent={2}
                                />
                            </List>
                            <List component="div" disablePadding>
                        ...
                        >
                            ...
                            <List component="div" disablePadding>
                                <LeftNavorganisms
                                    item={
                                        organisms.listsDoubleVariationsClickable
                                    }
                                    indent={2}
                                />
                            </List>
                            <List component="div" disablePadding>
                                <LeftNavorganisms
                                    item={
                                        organisms.listsTripleVariationsClickable
                                    }
                                    indent={2}
                                />
                            </List>
                        ...
                        <LeftNavItem
                            ...
                            indent={1}
                            onClick={() =>
                                setDisplayListImageLeft(!displayListsImageLeft)
                            }
                        >
                            {displayListsImageLeft ? (
                                <ExpandLess />
                        ...
                        >
                            <List component="div" disablePadding>
                                <LeftNavorganisms
                                    item={
                                        organisms.listsDoubleVariationsImageLeft
                                    }
                                    indent={2}
                                />
                            </List>
                            <List component="div" disablePadding>
                                <LeftNavorganisms
                                    item={
                                        organisms.listsDoubleVariationsClickableImageLeft
                                    }
                                    indent={2}
                                />
                            </List>
                        ...
                        <LeftNavItem
                            ...
                            indent={1}
                            onClick={() =>
                                setDisplayCardsClickable(!displayCardsClickable)
                            }
                        >
                            {displayCardsClickable ? (
                                <ExpandLess />
            ...
            >
                <div className="design-system-editor-right-content-scrollable">
                    ...
                    {showTemplate ===
                        organisms.listsDoubleVariationsImageLeft.value && (
                        <ErrorHandler>
                    ...
                    {showTemplate ===
                        organisms.listVariationsClickable.value && (
                        <ErrorHandler>
                            <ListsSingleClickable />
                        </ErrorHandler>
                    )}
                    {showTemplate ===
                        organisms.listsDoubleVariationsClickable.value && (
                        <ErrorHandler>
                    ...
                    {showTemplate ===
                        organisms.listsTripleVariationsClickable.value && (
                        <ErrorHandler>
                            <ListsTripleClickable />
                        </ErrorHandler>
                    )}
                    {showTemplate ===
                        organisms.cardVariationsStandard.value && (
                        <ErrorHandler>
                            <CardsStandard />
                        </ErrorHandler>
                    )}
                    ...
                    {showTemplate ===
                        organisms.imageCard916Variations.value && (
                        <ErrorHandler>
                    ...
                    {showTemplate ===
                        organisms.staticonCardVariations.value && (
                        <ErrorHandler>
                            <StatIconCardSamples />
                        </ErrorHandler>
                    )}
                    ...
                    {showTemplate ===
                        organisms.decoractivetextIconVariations.value && (
                        <ErrorHandler>
                            <DecorativeTextIconLayouts />
                        </ErrorHandler>
                    )}
                    {showTemplate ===
                        organisms.decoractivetextVariations.value && (
                        <ErrorHandler>
                    ...
                    {showTemplate ===
                        organisms.testimonCardVariations.value && (
                        <ErrorHandler>
