      ...
      <Grid container spacing={2} columns={12} margin={2}>
        <Grid item spacing={2} lg={12} md={12} sm={12}>
          ...
          <div>
            ...
            <p>
              To get started you will define your atoms, which are the very
              basic building blocks of your design language.
            </p>
            <p>
            ...
            <ol>
              <li>
                Define your{' '}
                <a onClick={event => changeTab('colorPalette')}>
                  Color Palette
                </a>
              </li>
              <li>
                Define your{' '}
                <a onClick={event => changeTab('colorThemes')}>Color Theme</a>
              </li>
            </ol>
            <p></p>
            <h6>Have Fun!</h6>
