...
export const BasicColorModeSelector: React.FC<SectionColorModeSelector> = ({
  colorMode,
  setColorMode,
  children,
}) => {
      ...
      <Grid container spacing={2} columns={12} margin={2}>
        <Grid item spacing={2} lg={12} md={12} sm={12}>
          ...
          <Typography variant="caption">
            View components on various background colors: default, colored,
            black, white or gradients
          </Typography>
          <RadioGroup
