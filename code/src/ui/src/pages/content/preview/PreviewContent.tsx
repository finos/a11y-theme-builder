...
export const PreviewContent: React.FC<Props> = ({ user, designSystem }) => {
    ...
    const [displayMobilePreview, setDisplayMobilePreview] = useState<boolean>(
        mobilePreviewSelected
    );
    useEffect(() => {
        ...
        <React.Fragment>
            <div className="design-system-editor-right-content">
                            ...
                            <section data-background="alt">
                                ...
                                >
                                    <Grid
                                        item
                                        spacing={2}
                                        className="v-center backgroundImage paralux"
                                        lg={12}
                                        style={{
                ...
                <div className="comingsoon">
                    Sample Template - more coming soon
                </div>
            </div>
        </React.Fragment>
    );
