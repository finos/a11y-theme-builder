                        ...
                        <>
                            <Grid container spacing={2} columns={12} margin={2}>
                                <Grid item spacing={2} lg={12} md={12} sm={12}>
                                    ...
                                    Once your design system has been created and
                                    you've tweaked all of the parameters for the
                                    various atoms, molecules and organisms, you
                                    can generate code that can be used to ensure
                                    accessibility-compliant applications.
                                    <ul>
                                        <li>
                                            For a web application:{' '}
                                            <p>
                                                CSS is generated. It can be
                                                copied into your application's
                                                css file and used style HTML or
                                                MUI React components to provide
                                                accessibile content.
                                            </p>
                                        </li>
                                        <li>
                                            For a design tool:{' '}
                                            <p>
                                                JSON tokens are generated. They
                                                can be copied and imported into
                                                your design tool such as Figma.
                                            </p>
                                        </li>
                                    </ul>
                                </Grid>
