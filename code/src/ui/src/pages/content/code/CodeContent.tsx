...
export const CodeContent: React.FC<Props> = ({ user, designSystem }) => {
  ...
  const [showItem, setShowItem] = React.useState(
    pref.get('code-content-selected') || 'code'
  );
  useEffect(() => {
            ...
            <>
              <Grid container spacing={2} columns={12} margin={2}>
                <Grid item spacing={2} lg={12} md={12} sm={12}>
                  ...
                  Once your design system has been created and you've tweaked
                  all of the parameters for the various atoms, molecules and
                  organisms, you can generate code that can be used to ensure
                  accessibility-compliant applications.
                  <ul>
                    <li>
                      For a web application:{' '}
                      <p>
                        CSS is generated. It can be copied into your
                        application's css file and used style HTML or MUI React
                        components to provide accessibile content.
                      </p>
                    </li>
                    <li>
                      For a design tool:{' '}
                      <p>
                        JSON tokens are generated. They can be copied and
                        imported into your design tool such as Figma.
                      </p>
                    </li>
                  </ul>
                </Grid>
              ...
              <Grid container spacing={2} columns={12} margin={2}>
                <Grid item spacing={2} lg={12} md={12} sm={12}>
                  ...
                  <div className="top40">
                    ...
                    <pre style={codeStyle}>{getCssCode()}</pre>
                    <Button
                      variant="contained"
                      onClick={() =>
                    ...
                    <Button
                      variant="outlined"
                      onClick={() =>
                        saveFile(getCssCode(), designSystem.name + '.css')
                      }
                    >
                      Download
                    </Button>
                  ...
                  <div className="top40">
                    <pre style={codeStyle}>Code goes here</pre>
                    <Button
                      variant="contained"
                      onClick={() =>
                        navigator.clipboard.writeText('Code goes here')
                      }
                    >
                      Copy
                    </Button>
                  ...
                  <div className="top40">
                    ...
                    <pre style={codeStyle}>{getMotionSensitivityCssCode()}</pre>
                    <Button
                      variant="contained"
                      onClick={() =>
                  ...
                  <div className="top40">
                    ...
                    <pre style={codeStyle}>{getDyslexiaCssCode()}</pre>
                    <Button
                      variant="contained"
                      onClick={() =>
                        navigator.clipboard.writeText(getDyslexiaCssCode())
                      }
                    >
                      Copy
                    </Button>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        saveFile(
                          getDyslexiaCssCode(),
                          designSystem.name + '-dyslexic.css'
                        )
                      }
                    >
                      Download
              ...
              <Grid container spacing={2} columns={12} margin={2}>
                <Grid item spacing={2} lg={12} md={12} sm={12}>
                  ...
                  <div className="top40">
                    ...
                    <pre style={codeStyle}>{getJsonBaseCode()}</pre>
                    <Button
                      variant="contained"
                      onClick={() =>
                        navigator.clipboard.writeText(getJsonBaseCode())
                      }
                    >
                      Copy
                    </Button>
                    ...
                    <Button
                      variant="outlined"
                      onClick={() =>
                        saveFile(getJsonBaseCode(), designSystem.name + '.json')
                      }
                    >
                      Download
                    </Button>
                  ...
                  <div className="top40">
                    ...
                    <pre style={codeStyle}>{getJsonCodeLM()}</pre>
                    <Button
                      variant="contained"
                      onClick={() =>
                        navigator.clipboard.writeText(getJsonCodeLM())
                      }
                    >
                      Copy
                    </Button>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        saveFile(
                          getJsonCodeLM(),
                          designSystem.name + '-darkmode.json'
                        )
                      }
                    >
                      Download
                  ...
                  <div className="top40">
                    ...
                    <pre style={codeStyle}>{getJsonCodeDM()}</pre>
                    <Button
                      variant="contained"
                      onClick={() =>
                        navigator.clipboard.writeText(getJsonCodeDM())
                      }
                    >
                      Copy
                    </Button>
