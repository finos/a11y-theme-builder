      ...
      MuiButton: {
        ...
        styleOverrides: {
          root: ({ ownerState }) => ({
            ...
            minHeight:
              'max(var(--min-target), calc(var(--button-height) * var(--spacing-1))) !important',
      ...
      MuiTab: {
        styleOverrides: {
          root: {
            ...
            padding: '0 var(--spacing-2)',
            minHeight:
              'max(var(--min-target), calc(calc(var(--button-height) * var(--spacing-1)) + 4px))',
            '&:hover': {
              opacity: '1',
            },
            '&:focus': {
      ...
      MuiPaginationItem: {
        styleOverrides: {
          root: {
            ...
            color: 'var(--button) !important',
            border:
              'calc(var(--border-1) * var(--button-border)) solid var(--button)',
            '&.Mui-selected': {
      ...
      MuiAlert: {
        styleOverrides: {
          root: {
            ...
            position: 'relative',
            paddingRight:
              'calc(calc(var(--toast-padding) * var(--spacing-1)) + var(--spacing-1)) !important',
            '& .MuiAlert-icon': {
          ...
          root: {
            ...
            '& .MuiSlider-thumb': {
              ...
              '&::after': {
                ...
                width: 'var(--min-target)',
                right:
                  'calc(0px - calc(var(--focusBorder) + 2px + var(--animation-focus-distance)))',
                bottom:
                  'calc(0px - calc(var(--focusBorder) + 2px + var(--animation-focus-distance)))',
                content: "''",
                background: '#000000',
      ...
      MuiChip: {
        styleOverrides: {
          root: {
            ...
            minHeight:
              'max(var(--min-target), calc(var(--chip-height) * var(--spacing-1))) !important',

            '&::after': {
              position: 'absolute',
              top: 'calc(((var(--min-target) - (var(--spacing-1) * var(--chip-height)))/2) - (var(--border-1) * 2) - 3px - var(--animation-focus-distance) - 2px)',
              bottom:
                'calc(((var(--min-target) - (var(--spacing-1) * var(--chip-height)))/2) - (var(--border-1) * 2) - 1px - var(--animation-focus-distance) - 2px)',
              padding: '0 calc(var(--spacing-1) * var(--chip-padding))',
              left: 'calc(-2px - calc(var(--border-1) * 2) - var(--animation-focus-distance))',
              right:
                'calc(-2px - calc(var(--border-1) * 2) - var(--animation-focus-distance))',
              borderRadius:
            ...
            '&::before': {
              ...
              bottom:
                'calc((var(--min-target) - (var(--spacing-1) * var(--chip-height)))/2)',
              padding: '0 calc(var(--spacing-1) * var(--chip-padding))',
              left: '0px',
              right: '0px',
              content: '""',
              ...
              minHeight:
                'calc( calc( var(--chip-height) * var(--spacing-1) ) - calc( var(--border-1) * var(--button-border) * 2 ))',
            },
            '&:hover::after': {
              opacity: '.5',
              top: 'calc(((var(--min-target) - (var(--spacing-1) * var(--chip-height)))/2) - 3px)',
              bottom:
                'calc(((var(--min-target) - (var(--spacing-1) * var(--chip-height)))/2) - 3px)',
            ...
            '& .MuiAvatar-root': {
              border:
                'solid calc(var(--border-1) * var(--avatar-border)) var(--on-chip) !important',
              magin: '0px !important',
            },
          },
        },
      ...
      MuiAvatar: {
        styleOverrides: {
          root: {
            ...
            border:
              'solid calc(var(--border-1) * var(--avatar-border-lg)) var(--button) !important',
            '&.xxs': {
              border:
                'solid calc(var(--border-1) * var(--avatar-border)) var(--button) !important',
            },
            '&.xs': {
              border:
                'solid calc(var(--border-1) * var(--avatar-border)) var(--button) !important',
            ...
            '&.black': {
              ...
              border:
                'solid calc(var(--border-1) * var(--avatar-border-lg)) var(--black) !important',
              '& svg path': {
                fill: 'var(--white)',
              },
              '&.xxs': {
                border:
                  'solid calc(var(--border-1) * var(--avatar-border)) var(--black) !important',
              },
              '&.xs': {
                border:
                  'solid calc(var(--border-1) * var(--avatar-border)) var(--black) !important',
            ...
            '&.white': {
              ...
              border:
                'solid calc(var(--border-1) * var(--avatar-border-lg)) var(--white) !important',
              '& svg path': {
                fill: 'var(--black)',
              },
              '&.xxs': {
                border:
                  'solid calc(var(--border-1) * var(--avatar-border)) var(--white) !important',
              },
              '&.xs': {
                border:
                  'solid calc(var(--border-1) * var(--avatar-border)) var(--white) !important',
