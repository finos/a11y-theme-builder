          ...
          <Grid container spacing={2} columns={12} margin={2}>
            <Grid item spacing={2} lg={8} md={12} sm={12}>
              ...
              <div className="body">
                ...
                <Divider />
                <ListComponent isClickable={true} hasImg type={3} title={'Episode 3'}  overline={'Season 1'}  body={'testing'}  ></ListComponent>
                <Divider />
                <ListComponent isClickable={true} hasImg type={3} title={'Episode 4'}  overline={'Season 1'}  body={'testing'}  ></ListComponent>
              </div>
            </Grid>
