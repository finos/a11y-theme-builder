    ...
    return (
        ...
        <Grid  justifyContent="center"  container spacing={2} columns={12} margin={2}>
          ...
          <Grid  justifyContent="center"  container spacing={2} columns={12} margin={2}>
            ...
            <Grid  justifyContent="center" item spacing={2} xl={10} sm={12} className="cardSection">
              <CardSample  icon={true} stat={true} className="fixed" title="Title"  clickable={false}   hideSecondary={true}>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                  sed do eiusmod tempor incididunt ut labore et dolore
                  magna aliqua
              </CardSample>
              <CardSample icon={true}  stat={true} className="fixed"  title="Title"   hideSecondary={true}>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                  sed do eiusmod tempor incididunt ut labore et dolore
                  magna aliqua
              </CardSample>
          ...
          <Grid  justifyContent="center"  container spacing={2} columns={12} margin={2}>
            ...
            <Grid  justifyContent="center" item spacing={2} xl={10} sm={12} className="cardSection">
              <CardSample icon={true}  stat={true} className="fixed" title="Title" clickable={true}>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                  sed do eiusmod tempor incididunt ut labore et dolore
                  magna aliqua
              </CardSample>
