...
export const ListDoubleIconLargeClickableImageLeft : React.FC<Props> = ({className=""}) => {
    return (
          ...
          <Grid container spacing={2} columns={12} margin={2}>
            ...
            <Grid item spacing={2} lg={8} md={12} sm={12}>
              ...
              <div className="body1">
                ...
                <Divider />
                <ListComponent isClickable={true} hasIcon isLarge type={2} title={'Episode 3'}  overline={'Season 1'}  body={'testing'}  ></ListComponent>
                <Divider />
                <ListComponent isClickable={true} hasIcon isLarge type={2} title={'Episode 4'}  overline={'Season 1'}  body={'testing'}  ></ListComponent>
              </div>
            </Grid>
